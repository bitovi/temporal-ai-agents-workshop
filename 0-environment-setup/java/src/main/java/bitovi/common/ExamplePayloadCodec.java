...
/**
 * Simple codec that adds dummy prefix to payload. For this sample it's also
 * applied for failure messages.
 */
public class ExamplePayloadCodec implements PayloadCodec {

    public static final ByteString PREFIX = ByteString.copyFromUtf8("PAYLOAD_PREFIX: ");
