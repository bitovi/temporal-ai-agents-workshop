...
public class CalculatorAdd {
    ...
    public static Tool getBedrockTool() {
        ...
        aPropertyMap.put("description", Document.fromString("The first number to add."));
        ...
        bPropertyMap.put("description", Document.fromString("The second number to add."));
        ...
        ToolSpecification specification = ToolSpecification.builder()
                ...
                .description(
                        "A simple calculator that adds two numbers together. Provide two numbers as input and it will return their sum.")
