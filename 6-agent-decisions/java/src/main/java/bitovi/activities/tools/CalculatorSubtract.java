...
public class CalculatorSubtract {
    ...
    public static Tool getBedrockTool() {
        ...
        aPropertyMap.put("description", Document.fromString("The first number to subtract."));
        ...
        bPropertyMap.put("description", Document.fromString("The second number to subtract."));
        ...
        ToolSpecification specification = ToolSpecification.builder()
                ...
                .description(
                        "A simple calculator that subtracts two numbers. Provide two numbers as input and it will return their difference.")
