...
public class ToolRegistry {
    ...
    static {
        ...
        toolExecutors.put("addition_calculator", CalculatorAdd::execute);
        toolExecutors.put("subtraction_calculator", CalculatorSubtract::execute);
        toolExecutors.put("multiplication_calculator", CalculatorMultiply::execute);
        toolExecutors.put("division_calculator", CalculatorDivide::execute);
    ...
    public static List<Tool> getAllBedrockTools() {
        ...
        tools.add(CalculatorAdd.getBedrockTool());
        tools.add(CalculatorSubtract.getBedrockTool());
        tools.add(CalculatorMultiply.getBedrockTool());
        tools.add(CalculatorDivide.getBedrockTool());
        return tools;
    }
